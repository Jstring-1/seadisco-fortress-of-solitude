...
(async function () {
  ...
  } else if (rawView === "wiki" || rawView === "loc" || rawView === "archive" || rawView === "youtube" || rawView === "gutenberg" || rawView === "chronam") {
    // LOC / Wikipedia / Archive: anon-accessible (read + search,
    // no save). YouTube + Gutenberg + Chronam: still admin/demo
    // gated. Wait for auth so the gate decision and save-button
    // visibility happen post-Clerk-resolve.
    await authReadyPromise;
    if (rawView === "youtube" || rawView === "gutenberg" || rawView === "chronam") await _ensureAdminFlag();
    switchView(rawView, true);
...
window.addEventListener("popstate", () => {
  ...
  if (rawView === "records" || rawView === "info" || rawView === "privacy" || rawView === "terms" || rawView === "wanted" || rawView === "account" || rawView === "loc" || rawView === "wiki" || rawView === "archive" || rawView === "youtube" || rawView === "gutenberg" || rawView === "chronam") {
    if (rawView === "records") {
