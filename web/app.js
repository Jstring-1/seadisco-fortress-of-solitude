...
(async function () {
  ...
  if (rawView.startsWith("records:")) {
  ...
  } else if (rawView === "wiki" || rawView === "loc" || rawView === "archive" || rawView === "youtube" || rawView === "gutenberg" || rawView === "chronam" || rawView === "blues-archive" || rawView === "admin") {
    ...
    await authReadyPromise;
    if (rawView === "youtube" || rawView === "gutenberg" || rawView === "chronam" || rawView === "blues-archive" || rawView === "admin") await _ensureAdminFlag();
    switchView(rawView, true);
...
// accounts are deleted after 6 weeks idle, so the nudge is worth showing.
