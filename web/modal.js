...
async function loadMasterVersions(event, masterId) {
  ...
  try {
    ...
    list.innerHTML = `
      ...
      <div class="mv-grid-scroll"><div class="mv-grid" style="display:grid;grid-template-columns:auto auto minmax(0,7rem) 6.4rem minmax(0,8rem) minmax(8rem,1fr);gap:0.2rem 0.7rem;font-size:0.75rem;min-width:38rem"></div></div>`;
